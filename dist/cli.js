...
import { DATA_DIR, SnapshotMissingError, openSnapshot, snapshot, snapshotAgeSeconds } from "./db.js";
import { listChats } from "./queries/chats.js";
import {                 exportMedia, findMedia } from "./queries/media.js";
import { readChat, searchMessages } from "./queries/messages.js";
import { resolvePhones } from "./queries/people.js";
import { stats } from "./queries/stats.js";
import { daySummary } from "./queries/summary.js";
import { AmbiguousChatError, ChatNotFoundError,              } from "./queries/types.js";
...
const MEDIA_KINDS = ["image", "video", "voice", "document", "sticker"]         ;
...
function renderMessages(messages           , showChat         )       {
